CLASS zcl_data_file_upload_fmc DEFINITION
...
CLASS zcl_data_file_upload_fmc IMPLEMENTATION.
...
* Load the data to the table via dynamic internal table
        ...
        TRY.
          ...
          CATCH
          cx_sy_create_data_error INTO DATA(cd_exception).
        ...
        TRY.
          ...
          CATCH
          cx_sy_open_sql_db INTO DATA(db_exception).
            response->set_status( i_code   = if_web_http_status=>bad_request
